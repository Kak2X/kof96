...
-- bizhawk detection
if memory.readbytesigned == nil then
	memory.readbytesigned = memory.read_s8;
	gui.pixel = gui.drawPixel;
	gui.box = function(a,b,c,d,e,f) gui.drawBox(a,b,c,d,f,e) end -- last two params switched
end	
