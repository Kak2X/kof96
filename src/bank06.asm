...
.startYanoSabi:
	mMvC_SetDamageNext $08, HITANIM_DROP_DB_A, PF3_SHAKELONG|PF3_FLASH_B_SLOW|PF3_OVERHEAD|PF3_LASTHIT
...
.startMigiriUgachi:
	mMvC_SetDamageNext $08, HITANIM_DROP_DB_A, PF3_SHAKELONG|PF3_FLASH_B_SLOW|PF3_LASTHIT
...
.startTumiYomi:
	...
	mMvC_SetDamageNext $08, HITANIM_HIT_MID0, PF3_SHAKELONG|PF3_FLASH_B_SLOW|PF3_LASTHIT
	mMvC_PlaySound SND_ID_28
...
.obj5_setHit2:
	...
	mMvC_SetDamageNext $08, HITANIM_DROP_MAIN, PF3_SHAKELONG|PF3_FLASH_B_SLOW
...
; If the autoguard triggers, however, the opponent flashes, uses a different hit anim, and receives more damage.
;
...
.obj1_autoguard_setNextFrame:
	...
	mMvC_SetDamageNext $08, HITANIM_HIT_MID0, PF3_SHAKELONG|PF3_FLASH_B_SLOW
	jp   .ret
.obj1_noAutoguard:
	mMvC_ValFrameEnd .anim
		;--
...
.obj2:
	mMvC_ValFrameEnd .anim
		...
		mMvC_SetDamageNext $01, HITANIM_HIT_MID0, PF3_FLASH_B_SLOW|PF3_LASTHIT
		jp   .ret
; --------------- frame #3 ---------------
.obj3:
	...
	mMvC_ValFrameEnd .anim
		...
		mMvC_SetDamageNext $18, HITANIM_DROP_MAIN, PF3_SHAKELONG|PF3_FLASH_B_SLOW|PF3_HALFSPEED
		;--
...
.obj3:
	...
	.obj3_setJumpE: ; [POI] Hidden Heavy
		mMvC_SetSpeedH +$0700
		mMvC_SetSpeedV -$0400
		mMvC_SetDamage $02, HITANIM_DROP_MAIN, PF3_FLASH_B_SLOW|PF3_LASTHIT
	.obj3_doGravity:
		jp   .doGravity
.obj3_cont:
	jp   .doGravity
...
.obj1_cont:
	...
	jp   nc, .doGravity
		mMvC_SetDamageNext $08, HITANIM_HIT_MID0, PF3_SHAKELONG
		jp   .doGravity
; --------------- frame #2 ---------------
.obj2:
	mMvC_NextFrameOnGtYSpeed -$01, ANIMSPEED_NONE
...
.obj2:
	...
	.obj2_setDamageL:
		mMvC_SetDamageNext $08, HITANIM_DROP_DB_A, $00
		jp   .doGravity
	.obj2_setDamageH:
		mMvC_SetDamageNext $08, HITANIM_DROP_DB_A, PF3_SHAKELONG
		jp   .doGravity
...
.obj0:
	mMvC_ValFrameStart .moveH
		mMvC_PlaySound SFX_STEP
		mMvC_SetSpeedH $0200
		mMvC_SetDamageNext $06, HITANIM_HIT_MID0, PF3_LASTHIT
		jp   .moveH
; --------------- frame #1 ---------------
.obj1:
	mMvC_ValFrameEnd .moveH
		mMvC_PlaySound SFX_STEP
		mMvC_SetDamageNext $06, HITANIM_HIT_MID1, PF3_LASTHIT
		jp   .moveH
; --------------- frame #2 ---------------
.obj2:
	mMvC_ValFrameEnd .moveH
		mMvC_SetAnimSpeed ANIMSPEED_NONE
		mMvC_PlaySound SFX_STEP
		mMvC_SetDamageNext $0A, HITANIM_DROP_MAIN, PF3_SHAKELONG
...
.obj0:
	mMvC_ValFrameEnd .anim
		mMvC_PlaySound SCT_14
		mMvC_SetDamageNext $09, HITANIM_DROP_MAIN, PF3_SHAKELONG|PF3_FLASH_B_SLOW|PF3_HALFSPEED
		jp   .anim
; --------------- frame #1 ---------------
.obj1:
	mMvC_ValFrameStart .obj1_cont
...
.obj1_cont:
	...
	mMvC_ValFrameEnd .anim
		mMvC_SetAnimSpeed ANIMSPEED_NONE
		mMvC_SetDamageNext $08, HITANIM_DROP_MAIN, PF3_SHAKELONG|PF3_FLASH_B_SLOW|PF3_HALFSPEED
		jp   .anim
; --------------- frame #2 ---------------
.obj2:
	mMvC_ValFrameStart .obj2_cont
...
.obj0_cont:
	mMvC_ValFrameEnd .moveH
		mMvC_SetDamageNext $02, HITANIM_HIT_MID0, PF3_LASTHIT
		jp   .moveH
...
.unused_obj1:
	mMvC_ValFrameEnd .moveH
		mMvC_PlaySound SFX_STEP
		mMvC_SetDamageNext $02, HITANIM_HIT_MID1, PF3_LASTHIT
		jp   .moveH
; --------------- frame #2 ---------------
...
.obj2:
	mMvC_ValFrameEnd .moveH
		mMvC_PlaySound SFX_STEP
		mMvC_SetDamageNext $02, HITANIM_DROP_MAIN, PF3_FLASH_B_SLOW|PF3_LASTHIT
		jp   .moveH
...
.obj1_cont:
	mMvC_ValFrameEnd .doGravity
		mMvC_SetDamageNext $01, HITANIM_HIT_MID0, PF3_LASTHIT
		jp   .doGravity
; --------------- frame #2 ---------------
; Again.
.obj2:
	mMvC_ValFrameEnd .doGravity
		mMvC_SetDamageNext $01, HITANIM_HIT_MID1, PF3_LASTHIT
		jp   .doGravity
; --------------- frame #3 ---------------
; Again.
.obj3:
...
.obj4_cont:
	mMvC_ValFrameEnd .anim
		mMvC_SetAnimSpeed $10
		; Note this won't hit twice since HITANIM_DROP_MAIN makes the opponent unhittable
		mMvC_SetDamageNext $04, HITANIM_DROP_MAIN, $00
		jp   .anim
...
.obj5:
	...
	.obj5_setDamage2:
		...
		mkhl $03, HITANIM_DROP_MAIN
		ld   hl, CHL
		ld   a, PF3_LASTHIT|PF3_FLASH_B_FAST|PF3_SHAKEONCE
		jp   .obj5_setDamage
	.obj5_setDamage3:
		mMvC_PlaySound SCT_15
		mkhl $03, HITANIM_DROP_MAIN
...
.obj1_cont:
	mMvC_ValFrameEnd .anim
		mMvC_SetAnimSpeed ANIMSPEED_NONE
		mMvC_SetDamageNext $04, HITANIM_HIT_MID0, PF3_SHAKELONG|PF3_LASTHIT
		jp   .anim
; --------------- frame #2 ---------------	
.obj2:
	mMvC_ValFrameStart .obj2_cont
...
.obj2:
	mMvC_ValFrameEnd .anim
		mMvC_SetDamageNext $08, HITANIM_HIT_MID0, PF3_LASTHIT
		mMvC_PlaySound SCT_HEAVY
		jp   .anim
; --------------- frame #3 ---------------	
.obj3:
...
.obj5:
	mMvC_ValFrameEnd .anim
		mMvC_SetDamageNext $08, HITANIM_HIT_MID1, PF3_LASTHIT
		mMvC_PlaySound SCT_HEAVY
		jp   .anim
; --------------- frame #6 ---------------	
.obj6:
...
.setDamageContS:
	...
	jp   .move
.setDamageContD:
	mMvC_SetDamage $02, HITANIM_DROP_MAIN, PF3_LASTHIT|PF3_SHAKEONCE
	jp   .move
...
.setDamageHit1:
	mkhl $02, HITANIM_HIT_MID1
	ld   hl, CHL
	jp   .setDamage
.setDamageHit0:
	mkhl $02, HITANIM_HIT_MID0
	ld   hl, CHL
.setDamage:
	ld   a, PF3_LASTHIT
	call Play_Pl_SetMoveDamageNext
...
.obj1_hitOk:
	...
	mMvC_SetDamageNext $08, HITANIM_HIT_MID1, PF3_SHAKELONG
