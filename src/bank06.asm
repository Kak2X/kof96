...
MoveInit_Kyo_AraKami:
	...
	add  hl, bc
	set  PF1B_GUARD, [hl]		; Reduce damage at first when getting hit out of this
...
.obj4_cont:
	mMvC_ValFrameEnd .anim
		mMvC_SetAnimSpeed $10
		; Note this won't hit twice since HITANIM_DROP_MD makes the opponent unhittable
...
.obj5:
	...
	.obj5_setDamage2:
		...
		mkhl $03, HITANIM_DROP_MD
		ld   hl, CHL
		ld   a, PF3_BIT4|PF3_FLASH_B_FAST|PF3_SHAKEONCE
		jp   .obj5_setDamage
	.obj5_setDamage3:
		mMvC_PlaySound SCT_15
		mkhl $03, HITANIM_DROP_MD
